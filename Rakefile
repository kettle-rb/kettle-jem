...
# kettle-jem Rakefile v1.0.0 - 2026-04-05
...
# rake install                                # Build and install kettle-jem-1.0.0.gem in...
# rake install:local                          # Build and install kettle-jem-1.0.0.gem in...
# rake kettle:jem:install                     # Install kettle-jem GitHub automation and ...
# rake kettle:jem:selftest                    # Self-test: template kettle-jem against itse...
# rake kettle:jem:template                    # Template kettle-jem files into the curren...
...
# kettle-jem Rakefile v1.2.5 - 2025-11-28
# Ruby 2.3 (Safe Navigation) or higher required
#
# MIT License (see License.txt)
#
